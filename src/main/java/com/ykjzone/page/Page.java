...
//    }
    ...
    public Map<String,Object> getPaginationData(){
        ...
        Boolean left_has_more_obj = new Boolean(left_has_more);
        Boolean right_has_more_obj = new Boolean(right_has_more);
        return new HashMap<String,Object>() {
            {
                put("left_pages", left_pages);
                put("right_pages", right_pages);
                put("current_page", current_page);
                put("left_has_more", left_has_more_obj);
                put("right_has_more", right_has_more_obj);
                put("num_pages", num_pages);
            }
        };
    }
}
